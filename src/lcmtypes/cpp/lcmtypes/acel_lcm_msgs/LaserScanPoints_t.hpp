...
#ifndef __acel_lcm_msgs_LaserScanPoints_t_hpp__
#define __acel_lcm_msgs_LaserScanPoints_t_hpp__

#include <vector>
#include "lcmtypes/acel_lcm_msgs/Pose_t.hpp"
#include "lcmtypes/acel_lcm_msgs/Point3Df_t.hpp"
#include "lcmtypes/acel_lcm_msgs/QuadrotorTransform.hpp"
...
{
    public:
        acel_lcm_msgs::Pose_t trans_sensor2world;

        int64_t    point_num;

        std::vector< acel_lcm_msgs::Point3Df_t > points;

        acel_lcm_msgs::QuadrotorTransform pose;
...
uint64_t LaserScanPoints_t::_computeHash(const __lcm_hash_ptr *p)
{
    ...
    for(fp = p; fp != NULL; fp = fp->parent)
        if(fp->v == LaserScanPoints_t::getHash)
            return 0;
    const __lcm_hash_ptr cp = { p, (void*)LaserScanPoints_t::getHash };

    uint64_t hash = 0x41cb5b1499974f70LL +
         acel_lcm_msgs::Pose_t::_computeHash(&cp) +
         acel_lcm_msgs::Point3Df_t::_computeHash(&cp) +
         acel_lcm_msgs::QuadrotorTransform::_computeHash(&cp);
