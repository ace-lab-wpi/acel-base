...
#ifndef _acel_lcm_msgs_Vertex_t_h
#define _acel_lcm_msgs_Vertex_t_h

#ifdef __cplusplus
extern "C" {
#endif

typedef struct _acel_lcm_msgs_Vertex_t acel_lcm_msgs_Vertex_t;
struct _acel_lcm_msgs_Vertex_t
{
    int64_t    id;
    float      position[3];
};
...
/**
 * Create a deep copy of a acel_lcm_msgs_Vertex_t.
 * When no longer needed, destroy it with acel_lcm_msgs_Vertex_t_destroy()
 */
acel_lcm_msgs_Vertex_t* acel_lcm_msgs_Vertex_t_copy(const acel_lcm_msgs_Vertex_t* to_copy);

/**
 * Destroy an instance of acel_lcm_msgs_Vertex_t created by acel_lcm_msgs_Vertex_t_copy()
 */
void acel_lcm_msgs_Vertex_t_destroy(acel_lcm_msgs_Vertex_t* to_destroy);

/**
 * Identifies a single subscription.  This is an opaque data type.
 */
typedef struct _acel_lcm_msgs_Vertex_t_subscription_t acel_lcm_msgs_Vertex_t_subscription_t;

/**
 * Prototype for a callback function invoked when a message of type
 * acel_lcm_msgs_Vertex_t is received.
 */
typedef void(*acel_lcm_msgs_Vertex_t_handler_t)(const lcm_recv_buf_t *rbuf,
             const char *channel, const acel_lcm_msgs_Vertex_t *msg, void *userdata);

/**
 * Publish a message of type acel_lcm_msgs_Vertex_t using LCM.
 *
 ...
 */
int acel_lcm_msgs_Vertex_t_publish(lcm_t *lcm, const char *channel, const acel_lcm_msgs_Vertex_t *msg);

/**
 * Subscribe to messages of type acel_lcm_msgs_Vertex_t using LCM.
 *
 ...
 */
acel_lcm_msgs_Vertex_t_subscription_t* acel_lcm_msgs_Vertex_t_subscribe(lcm_t *lcm, const char *channel, acel_lcm_msgs_Vertex_t_handler_t handler, void *userdata);

/**
 * Removes and destroys a subscription created by acel_lcm_msgs_Vertex_t_subscribe()
 */
...
/**
 * Encode a message of type acel_lcm_msgs_Vertex_t into binary form.
 *
 * @param buf The output buffer.
 * @param offset Encoding starts at this byte offset into @p buf.
 * @param maxlen Maximum number of bytes to write.  This should generally
 *               be equal to acel_lcm_msgs_Vertex_t_encoded_size().
...
/**
 * Decode a message of type acel_lcm_msgs_Vertex_t from binary form.
 * When decoding messages containing strings or variable-length arrays, this
 * function may allocate memory.  When finished with the decoded message,
 * release allocated resources with acel_lcm_msgs_Vertex_t_decode_cleanup().
 *
 ...
 */
int acel_lcm_msgs_Vertex_t_decode(const void *buf, int offset, int maxlen, acel_lcm_msgs_Vertex_t *msg);

/**
 * Release resources allocated by acel_lcm_msgs_Vertex_t_decode()
 * @return 0
 */
int acel_lcm_msgs_Vertex_t_decode_cleanup(acel_lcm_msgs_Vertex_t *p);

/**
 * Check how many bytes are required to encode a message of type acel_lcm_msgs_Vertex_t
 */
